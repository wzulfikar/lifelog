...
Regardless of events triggered, you don't need to handle all the events. However, you need to handle at least `ajax.{ajax-id}.success` and `ajax.{ajax-id}.error` events to give a good feedback for your users.
