...
The second issue, I can host my own Wordpress site. However, Wordpress store thus posts (and almost anything else) in database, I don't feel good with it. I want to store thus things in say, markdown file.
